...
pipeline {
    ...
    stages{
        ...
        stage ("Deploy to Autosys"){
            ...
            steps{		
		sh "scp -i /var/lib/jenkins/.ssh/id_rsa test1.py srvamr-sfaops@amer@10.191.97.113:/app/etl/palign/scripts/scripts_ui/python_scripts"
		sh "ssh -i /var/lib/jenkins/.ssh/id_rsa srvamr-sfaops@amer@10.191.97.113 'sudo chmod 775 /app/etl/palign/scripts/scripts_ui/python_scripts/*'"  
